...
function GrokAIAssistant() {
  ...
  return (
    <GrokProvider>
      <div className="flex min-h-screen flex-col has-mobile-nav">
        <main className="flex-grow container mx-auto px-4 pt-20 pb-24 sm:pb-12" id="main-content" tabIndex={-1}>
          <div className="mb-8 relative page-heading">
          ...
          <Tabs defaultValue="chat" className="w-full">
            <TabsList className="grid grid-cols-3 mb-8 bg-green-50 dark:bg-green-900/20 rounded-lg overflow-hidden">
            ...
            <TabsContent value="analysis">
              <div className="text-center py-12 border border-green-200 dark:border-green-900/50 rounded-lg bg-green-50/50 dark:bg-green-900/10">
                ...
                <div className="inline-block px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors cursor-pointer">
                  Join Waitlist
                </div>
              </div>
            </TabsContent>
