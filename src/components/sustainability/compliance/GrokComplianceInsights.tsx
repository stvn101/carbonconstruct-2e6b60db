...
import { AlertTriangle, Brain, RefreshCw, Check, X } from 'lucide-react';
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <h3 className="font-medium">NCC 2025 Analysis</h3>
                <Badge 
              ...
              {nccAnalysis ? (
                ...
                <div className="h-24 flex items-center justify-center text-sm text-muted-foreground">
                  ...
                  Analyzing NCC compliance...
                </div>
              ) : (
                <div className="text-sm text-muted-foreground italic">
                  Click "Analyze" to get AI insights on NCC compliance
                </div>
              )}
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <h3 className="font-medium">NABERS Analysis</h3>
                <Badge 
              ...
              {nabersAnalysis ? (
                ...
                <div className="text-sm text-muted-foreground italic">
                  Click "Analyze" to get AI insights on NABERS performance
                </div>
              )}
            </div>
          </div>
