      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
            ...
            <p className="text-lg md:text-xl text-carbon-800 dark:text-carbon-200 mb-6 max-w-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" asChild className="bg-carbon-600 hover:bg-carbon-700 text-white">
                <a href="#demo">Get Started</a>
              </Button>
              <Button size="lg" variant="outline" asChild className="border-carbon-500 text-carbon-800 hover:bg-carbon-100 dark:text-carbon-200 dark:hover:bg-carbon-800/50">
                ...
                <div className="space-y-4">
                  <div className="bg-secondary/50 p-4 rounded-lg">
                    ...
                    <div className="w-full bg-secondary rounded-full h-2">
                      <div className="bg-carbon-500 dark:bg-carbon-400 h-2 rounded-full" style={{ width: '78%' }}></div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-secondary/50 p-3 rounded-lg">
                      ...
                      <div className="text-xl font-bold text-carbon-600 dark:text-carbon-300">42.3</div>
                      <div className="text-xs text-carbon-700 dark:text-carbon-400">tonnes CO₂e</div>
                    </div>
                    <div className="bg-secondary/50 p-3 rounded-lg">
                      <div className="text-sm font-medium mb-1">Transport</div>
                      <div className="text-xl font-bold text-carbon-600 dark:text-carbon-300">28.7</div>
                      <div className="text-xs text-carbon-700 dark:text-carbon-400">tonnes CO₂e</div>
                    </div>
                    <div className="bg-secondary/50 p-3 rounded-lg">
                      <div className="text-sm font-medium mb-1">Energy</div>
                      <div className="text-xl font-bold text-carbon-600 dark:text-carbon-300">15.2</div>
                      <div className="text-xs text-carbon-700 dark:text-carbon-400">tonnes CO₂e</div>
                    </div>
                    <div className="bg-secondary/50 p-3 rounded-lg">
                      <div className="text-sm font-medium mb-1">Total</div>
                      <div className="text-xl font-bold text-carbon-600 dark:text-carbon-300">86.2</div>
                      <div className="text-xs text-carbon-700 dark:text-carbon-400">tonnes CO₂e</div>
                    </div>
                  </div>
                </div>
