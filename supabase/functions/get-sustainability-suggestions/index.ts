...
import { ReportFormat, SustainabilityReport, ReportRequestOptions } from "./Report.ts";
...
serve(async (req) => {
  ...
  try {
    ...
    if (reportOptions.format === ReportFormat.BASIC || reportOptions.format === ReportFormat.COMPREHENSIVE) {
